...
**Required Tools:** qdrant-find, agent
**Optional Tools:** None
...
<instructions>
1. Call qdrant-find with collection {{PLAN_NAME}}, query "failed attempts verification failures and error details" to retrieve the full failure history — what was attempted, what specifically failed, and the verification error output.
